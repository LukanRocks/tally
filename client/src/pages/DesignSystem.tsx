    ...
    <Page className='space-y-8'>
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            Lucide, 1.75 stroke, 20×20 by default. Brand glyphs (tally bars, dice, podium) are
            custom SVGs and live in <code className='font-mono text-xs'>/icons/brand</code>.
          </p>
        </div>

        <div className='grid grid-cols-[repeat(auto-fill,minmax(96px,1fr))] gap-2'>
          {([
            { label: 'chart',   brand: false, path: <><path d='M3 3v18h18' /><path d='M7 14l4-4 4 3 5-6' /></> },
            { label: 'dice',    brand: false, path: <><rect x='3' y='3' width='18' height='18' rx='3' /><circle cx='8' cy='8' r='1.3' /><circle cx='16' cy='16' r='1.3' /><circle cx='16' cy='8' r='1.3' /><circle cx='8' cy='16' r='1.3' /><circle cx='12' cy='12' r='1.3' /></> },
            { label: 'trophy',  brand: false, path: <><path d='M6 9h12l-1 9H7z' /><path d='M9 9V6a3 3 0 016 0v3' /></> },
            { label: 'player',  brand: false, path: <><circle cx='12' cy='8' r='4' /><path d='M4 21a8 8 0 0116 0' /></> },
            { label: 'session', brand: false, path: <><rect x='3' y='6' width='18' height='14' rx='2' /><path d='M8 6V4M16 6V4M3 11h18' /></> },
            { label: 'list',    brand: false, path: <><path d='M4 7h16M4 12h16M4 17h10' /></> },
            { label: 'grid',    brand: false, path: <><rect x='3' y='3' width='7' height='7' rx='1.5' /><rect x='14' y='3' width='7' height='7' rx='1.5' /><rect x='3' y='14' width='7' height='7' rx='1.5' /><rect x='14' y='14' width='7' height='7' rx='1.5' /></> },
            { label: 'search',  brand: false, path: <><circle cx='11' cy='11' r='7' /><path d='M21 21l-4.3-4.3' /></> },
            { label: 'plus',    brand: false, path: <><path d='M12 5v14M5 12h14' /></> },
          ]).map(({ label, brand, path }) => (
            <div key={label} className={cn('flex flex-col items-center gap-2 rounded-lg border border-border p-3 text-ink-primary', brand && 'border-yellow-tertiary/40 bg-yellow-secondary/40 text-yellow-tertiary')}>
          ...
          <div className='flex flex-col items-center gap-2 rounded-lg border border-yellow-tertiary/40 bg-yellow-secondary/40 p-3 text-yellow-tertiary'>
            ...
            <span className='font-mono text-[10px] text-ink-muted'>tally <em className='not-italic text-ink-muted/60'>brand</em></span>
          </div>
        </div>
      </section>
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            One primary per surface. Yellow is loud; reserve it for the single most important action.
          </p>
        </div>
        ...
        <div className='space-y-4 rounded-xl border border-border bg-card p-5'>
          ...
          <div className='flex flex-wrap items-center gap-3'>
            <button className='inline-flex h-9.5 cursor-pointer items-center gap-2 rounded-md border border-yellow-tertiary bg-yellow-primary px-3.5 text-sm font-semibold text-ink-primary shadow-xs transition-colors hover:bg-yellow-tertiary'>
              + Log session
            </button>
            ...
            <button disabled className='inline-flex h-9.5 cursor-not-allowed items-center gap-2 rounded-md border border-yellow-tertiary bg-yellow-primary px-3.5 text-sm font-semibold text-ink-primary opacity-45'>
              Disabled
            </button>
          </div>
          ...
          <div className='flex flex-wrap items-center gap-3'>
            <button className='inline-flex h-7.5 cursor-pointer items-center gap-2 rounded-md border border-yellow-tertiary bg-yellow-primary px-2.5 text-xs font-semibold text-ink-primary transition-colors hover:bg-yellow-tertiary'>
              + Log
            </button>
            <button className='inline-flex h-9.5 cursor-pointer items-center gap-2 rounded-md border border-yellow-tertiary bg-yellow-primary px-3.5 text-sm font-semibold text-ink-primary transition-colors hover:bg-yellow-tertiary'>
              + Log session
            </button>
            <button className='inline-flex h-11.5 cursor-pointer items-center gap-2 rounded-md border border-yellow-tertiary bg-yellow-primary px-5 text-[15px] font-semibold text-ink-primary transition-colors hover:bg-yellow-tertiary'>
              + Log session tonight
            </button>
          </div>
          ...
          <div className='flex flex-wrap items-center gap-3'>
            ...
            <button aria-label='Search' className='inline-flex h-9.5 w-9.5 cursor-pointer items-center justify-center rounded-md border border-border bg-card text-ink-primary transition-colors hover:bg-paper-secondary'>
              <svg width='18' height='18' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='1.75' strokeLinecap='round' strokeLinejoin='round'>
                <circle cx='11' cy='11' r='7' />
                <path d='M21 21l-4.3-4.3' />
              </svg>
            </button>
            <button aria-label='Log a session' className='inline-flex h-14 w-14 cursor-pointer items-center justify-center rounded-full border-[1.5px] border-ink-primary bg-yellow-primary text-ink-primary shadow-stamp transition-[transform,box-shadow] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0_var(--ink-primary)] active:translate-x-px active:translate-y-px'>
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            1px line border, paper-tinted fill, yellow focus ring. Heights match button heights so they line up in forms.
          </p>
        </div>
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <label className='flex flex-col gap-1.5'>
            ...
            <div className='relative'>
              <svg className='pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-ink-muted' width='16' height='16' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='1.75' strokeLinecap='round' strokeLinejoin='round'>
                <circle cx='11' cy='11' r='7' />
                <path d='M21 21l-4.3-4.3' />
              </svg>
          ...
          <div className='flex flex-wrap gap-4'>
            <div className='inline-flex gap-0.5 rounded-md border border-border bg-paper-secondary p-0.5' role='tablist' aria-label='Ownership'>
              {(['All', "Owned", "Friends'", 'Rented'] as const).map((opt, i) => (
                <button key={opt} role='tab' className={cn('rounded-[5px] px-3 py-1.5 text-sm font-medium transition-colors', i === 0 ? 'bg-card font-semibold text-ink-primary shadow-xs' : 'text-ink-secondary hover:text-ink-primary')}>
                  {opt}
                </button>
              ))}
            </div>
            ...
            <div className='inline-flex gap-0.5 rounded-md border border-border bg-paper-secondary p-0.5' role='tablist' aria-label='Duration'>
              {(['15m', '30m', '~1h', '2h+'] as const).map((opt, i) => (
                <button key={opt} role='tab' className={cn('rounded-[5px] px-3 py-1.5 text-sm font-medium transition-colors', i === 2 ? 'bg-card font-semibold text-ink-primary shadow-xs' : 'text-ink-secondary hover:text-ink-primary')}>
                  {opt}
                </button>
              ))}
            </div>
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            Two shapes, one job each. <strong>Pills</strong> are rounded; they carry status and
            selection. <strong>Chips</strong> are squared; they carry metadata (player counts,
            times, tags).
          </p>
        </div>
        ...
        <div className='space-y-4 rounded-xl border border-border bg-card p-5'>
          ...
          <div className='flex flex-wrap items-center gap-2'>
            <span className='inline-flex h-7 items-center rounded-full border border-border bg-card px-3 text-sm font-medium text-ink-primary'>
              Default
            </span>
            <span className='inline-flex h-7 items-center rounded-full border border-ink-primary bg-ink-primary px-3 text-sm font-medium text-paper-primary'>
              Selected
            </span>
            <span className='inline-flex h-7 items-center rounded-full border border-yellow-tertiary/35 bg-yellow-secondary px-3 text-sm font-medium text-ink-primary'>
              Soft
            </span>
            <span className='inline-flex h-7 items-center rounded-full border border-dashed border-border bg-transparent px-3 text-sm font-medium text-ink-muted'>
              + add
            </span>
            <span className='inline-flex h-7 items-center gap-1.5 rounded-full border border-border bg-card pl-1.5 pr-1 text-sm font-medium text-ink-primary'>
              <span className='inline-flex h-4.5 w-4.5 items-center justify-center rounded-full border border-black/10 text-[10px] font-bold text-ink-primary' style={{ background: 'var(--player-a)' }}>A</span>
              Alyne
              <button aria-label='remove' className='ml-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full text-base leading-none text-ink-muted hover:bg-paper-secondary hover:text-ink-primary'>×</button>
            </span>
          </div>

          <p className='eyebrow text-ink-muted'>Chip — metadata</p>
          <div className='flex flex-wrap items-center gap-2'>
            <span className='inline-flex h-6 items-center rounded-sm border border-border bg-paper-secondary px-2 font-mono text-[11.5px] font-medium text-ink-primary'>2–4 players</span>
            ...
            <span className='inline-flex h-6 items-center rounded-sm border border-border bg-paper-secondary px-2 font-mono text-[11.5px] font-medium text-ink-primary'>strategy</span>
            <span className='inline-flex h-6 items-center rounded-sm border border-yellow-tertiary/40 bg-yellow-secondary px-2 font-mono text-[11.5px] font-medium text-ink-primary'>★ best for 3</span>
          ...
          <div className='flex flex-wrap items-center gap-2'>
            <span className='inline-flex items-center rounded-[4px] border border-yellow-tertiary bg-yellow-primary px-2 py-0.5 font-mono text-[10px] font-bold uppercase tracking-[1.2px] text-ink-primary'>OWN</span>
            <span className='inline-flex items-center rounded-[4px] border border-player-b/60 bg-player-b px-2 py-0.5 font-mono text-[10px] font-bold uppercase tracking-[1.2px] text-ink-primary'>FRIEND</span>
            <span className='inline-flex items-center rounded-[4px] border border-player-a/60 bg-player-a px-2 py-0.5 font-mono text-[10px] font-bold uppercase tracking-[1.2px] text-ink-primary'>RENT</span>
            <span className='inline-flex items-center rounded-[4px] border border-ink-primary bg-ink-primary px-2 py-0.5 font-mono text-[10px] font-bold uppercase tracking-[1.2px] text-paper-primary'>NEW</span>
          </div>
        </div>
      </section>
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            Initial-based, colored per-player. Color is assigned at player creation and never
            changes — that's how someone becomes "the pink one".
          </p>
        </div>
        ...
        <div className='space-y-4 rounded-xl border border-border bg-card p-5'>
          ...
          <div className='flex flex-wrap items-center gap-4'>
            <span className='inline-flex h-5 w-5 items-center justify-center rounded-full border border-ink-primary font-sans text-[10px] font-bold text-ink-primary' style={{ background: 'var(--player-a)' }}>A</span>
            <span className='inline-flex h-7 w-7 items-center justify-center rounded-full border border-ink-primary font-sans text-xs font-bold text-ink-primary' style={{ background: 'var(--player-a)' }}>A</span>
            <span className='inline-flex h-9 w-9 items-center justify-center rounded-full border-[1.5px] border-ink-primary font-sans text-sm font-bold text-ink-primary' style={{ background: 'var(--player-a)' }}>A</span>
            <span className='inline-flex h-14 w-14 items-center justify-center rounded-full border-2 border-ink-primary font-sans text-[22px] font-bold text-ink-primary' style={{ background: 'var(--player-a)' }}>A</span>
            <span className='inline-flex h-22 w-22 items-center justify-center rounded-full border-[2.5px] border-ink-primary font-sans text-4xl font-bold text-ink-primary' style={{ background: 'var(--player-a)' }}>A</span>
          ...
          <div className='flex flex-wrap items-center gap-3'>
            {([
              ...
              { p: 'e', initial: 'J' },
              { p: 'f', initial: 'K' },
            ] as const).map(({ p, initial }) => (
              <span key={p} className='inline-flex h-14 w-14 items-center justify-center rounded-full border-2 border-ink-primary font-sans text-[22px] font-bold text-ink-primary' style={{ background: `var(--player-${p})` }}>
                {initial}
              </span>
            ))}
          </div>
          ...
          <div className='flex flex-wrap items-center gap-8'>
            <div className='flex items-center'>
              {(['a', 'b', 'c'] as const).map((p, i) => (
                <span key={p} className='inline-flex h-9 w-9 items-center justify-center rounded-full border-[1.5px] border-ink-primary font-sans text-sm font-bold text-ink-primary' style={{ background: `var(--player-${p})`, marginLeft: i === 0 ? 0 : '-10px', boxShadow: '0 0 0 2px var(--card)' }}>
                  {['A', 'M', 'G'][i]}
                </span>
              ))}
              <span className='inline-flex h-9 w-9 items-center justify-center rounded-full border-[1.5px] border-ink-primary bg-paper-secondary font-mono text-xs font-semibold text-ink-primary' style={{ marginLeft: '-10px', boxShadow: '0 0 0 2px var(--card)' }}>
                +2
              </span>
            </div>
            ...
            {([
              ...
              { medal: '🥈', p: 'b', initial: 'M' },
              { medal: '🥉', p: 'c', initial: 'G' },
            ] as const).map(({ medal, p, initial }) => (
              <div key={p} className='flex flex-col items-center gap-1'>
                <span className='text-lg'>{medal}</span>
                <span className='inline-flex h-14 w-14 items-center justify-center rounded-full border-2 border-ink-primary font-sans text-[22px] font-bold text-ink-primary' style={{ background: `var(--player-${p})` }}>
                  {initial}
                </span>
              </div>
            ))}
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            One radius (12px), one resting shadow, one hover state. Variants differ by{' '}
            <em>content density</em>, not by visual style.
          </p>
        </div>
        ...
        <div>
          ...
          <div className='overflow-hidden rounded-xl border border-border bg-card shadow-sm'>
            {([
            ...
            ] as const).map(({ title, meta, stars }, i, arr) => (
              <div key={title} className={cn('grid grid-cols-[44px_1fr_auto_auto] items-center gap-3.5 px-4 py-3', i < arr.length - 1 && 'border-b border-dashed border-border')}>
                <div className='h-11 w-11 rounded-lg border border-border' style={{ background: 'repeating-linear-gradient(135deg, var(--paper-secondary) 0 6px, var(--paper-muted) 6px 12px)' }} />
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            Desktop has a left rail. Mobile has a bottom tab bar with the FAB floating above. Both
            share the same 5 destinations.
          </p>
        </div>
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <div className='overflow-hidden rounded-xl border border-border bg-card shadow-sm'>
            ...
            <div className='border-t border-border bg-paper-primary px-3.5 py-3'>
              ...
              <div className='flex flex-col gap-0.5'>
                ...
                ] as const).map(({ icon, label, active, dot }) => (
                  <div key={label} className={cn('flex cursor-pointer items-center gap-2.5 rounded-md px-2.5 py-2 text-[13.5px] transition-colors', active ? 'bg-paper-secondary font-semibold text-ink-primary' : 'text-ink-secondary hover:bg-paper-secondary hover:text-ink-primary')}>
                ...
                <div className='flex cursor-pointer items-center gap-2.5 rounded-md bg-ink-primary px-2.5 py-2 text-[13.5px] font-semibold text-paper-primary hover:bg-ink-secondary'>
                  ...
                  Log session
                  <kbd className='ml-auto rounded px-1.5 py-0.5 font-mono text-[10px]' style={{ background: 'rgba(255,255,255,0.1)' }}>⌘N</kbd>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className='overflow-hidden rounded-xl border border-border bg-card shadow-sm'>
            ...
            <div className='relative flex h-70 flex-col border-t border-border bg-paper-primary'>
              ...
              <button aria-label='Log session' className='absolute right-4 bottom-17 inline-flex h-13 w-13 items-center justify-center rounded-full border-[1.5px] border-ink-primary bg-yellow-primary text-ink-primary shadow-stamp'>
                <svg width='22' height='22' viewBox='0 0 24 24' fill='none' stroke='currentColor' strokeWidth='2.5' strokeLinecap='round'>
                  <path d='M12 5v14M5 12h14' />
                </svg>
              </button>
              <div className='grid grid-cols-4 border-t border-border bg-card'>
                {([
                  ...
                  <div key={label} className={cn('flex flex-col items-center gap-1 py-2.5 font-mono text-[10px] tracking-[0.6px]', active ? 'font-bold text-ink-primary' : 'text-ink-muted')}>
        ...
        <div>
          ...
          <div className='flex items-center justify-between gap-4 rounded-xl border border-border bg-card px-4 py-3.5 shadow-sm'>
            <div className='flex flex-col gap-0.5'>
              <h3 className='text-lg font-bold leading-none'>Library</h3>
              <span className='text-xs text-ink-muted'>12 games</span>
            </div>
            <div className='flex items-center gap-2'>
              <span className='inline-flex h-6 cursor-pointer items-center rounded-sm border border-border bg-paper-secondary px-2 font-mono text-[11.5px] text-ink-primary'>All ▾</span>
              <span className='inline-flex h-6 cursor-pointer items-center rounded-sm border border-border bg-paper-secondary px-2 font-mono text-[11.5px] text-ink-primary'>Sort: recent ▾</span>
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            Toasts in the bottom-left. Banners inline at the top of a surface. Both auto-dismiss
            for non-blocking news; require a tap for "you did a thing".
          </p>
        </div>

        <div className='grid grid-cols-2 gap-4'>
          <div className='flex items-center gap-3 rounded-lg bg-ink-primary px-3.5 py-3 shadow-md'>
            <span className='inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-yellow-primary font-bold text-[13px] text-ink-primary'>✓</span>
            <div className='flex flex-1 flex-col gap-0.5'>
              <span className='text-sm font-bold text-paper-primary'>Session logged.</span>
              <span className='text-xs' style={{ color: 'color-mix(in oklch, var(--paper-primary) 60%, transparent)' }}>Alyne · Rumikubi · 4 players</span>
            </div>
            <button className='inline-flex h-7.5 cursor-pointer items-center rounded-md px-2.5 text-xs font-semibold text-yellow-primary transition-colors hover:bg-white/8'>Undo</button>
          </div>

          <div className='flex items-center gap-3 rounded-lg bg-ink-primary px-3.5 py-3 shadow-md'>
            <span className='inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-loss font-bold text-[13px] text-paper-primary'>!</span>
            <div className='flex flex-1 flex-col gap-0.5'>
              <span className='text-sm font-bold text-paper-primary'>Couldn't save</span>
              <span className='text-xs' style={{ color: 'color-mix(in oklch, var(--paper-primary) 60%, transparent)' }}>Try again — you'll keep what you entered.</span>
            </div>
            <button className='inline-flex h-7.5 cursor-pointer items-center rounded-md px-2.5 text-xs font-semibold text-yellow-primary transition-colors hover:bg-white/8'>Retry</button>
          </div>
        </div>
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            The most-touched component in the app. Avatar · name · score · trend, with an emphasis
            on <em>change</em>, not just standing.
          </p>
        </div>
        ...
        <div className='overflow-hidden rounded-xl border border-border bg-card shadow-sm'>
          {([
          ...
          ] as const).map(({ rank, p, initial, name, meta, streak, score, delta, trend }, i, arr) => (
            <div
              key={name}
              className={cn(
            ...
            >
              ...
              <span className='inline-flex h-14 w-14 items-center justify-center rounded-full border-2 border-ink-primary font-sans text-[22px] font-bold text-ink-primary' style={{ background: `var(--player-${p})` }}>{initial}</span>
              <div className='flex flex-col gap-0.5'>
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            Used at the top of Home and at the end of a session. Three columns; the winner is
            taller, centered, with yellow paper.
          </p>
        </div>
        ...
        <div className='rounded-xl border border-border bg-card p-6 shadow-sm'>
          ...
          <div className='grid grid-cols-3 items-end gap-2'>
            ...
            <div className='flex flex-col items-center gap-1.5 text-center'>
              <span className='inline-flex h-14 w-14 items-center justify-center rounded-full border-2 border-ink-primary font-sans text-[22px] font-bold text-ink-primary' style={{ background: 'var(--player-b)' }}>M</span>
              <span className='text-[15px] font-bold text-ink-primary'>Marina</span>
              <span className='text-xs text-ink-muted'>5 pts</span>
              <div className='mt-1.5 flex h-20 w-full items-center justify-center rounded-t-lg border-[1.5px] border-ink-primary bg-paper-secondary font-mono text-xl font-bold text-ink-primary'>2</div>
            </div>
            {/* 1st */}
            <div className='-translate-y-3 flex flex-col items-center gap-1.5 text-center'>
              <span className='inline-flex h-22 w-22 items-center justify-center rounded-full border-[2.5px] border-ink-primary font-sans text-4xl font-bold text-ink-primary' style={{ background: 'var(--player-a)' }}>A</span>
              <span className='text-[15px] font-bold text-ink-primary'>Alyne</span>
              <span className='text-xs text-ink-muted'>9 pts · 🔥 3</span>
              <div className='mt-1.5 flex h-[110px] w-full items-center justify-center rounded-t-lg border-[1.5px] border-ink-primary bg-yellow-primary font-mono text-xl font-bold text-ink-primary'>1</div>
            </div>
            {/* 3rd */}
            <div className='flex flex-col items-center gap-1.5 text-center'>
              <span className='inline-flex h-14 w-14 items-center justify-center rounded-full border-2 border-ink-primary font-sans text-[22px] font-bold text-ink-primary' style={{ background: 'var(--player-c)' }}>G</span>
              <span className='text-[15px] font-bold text-ink-primary'>Guillain</span>
              <span className='text-xs text-ink-muted'>2 pts</span>
              <div className='mt-1.5 flex h-14 w-full items-center justify-center rounded-t-lg border-[1.5px] border-ink-primary bg-paper-secondary font-mono text-xl font-bold text-ink-primary opacity-80'>3</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            Two density modes. The rich card carries cover art and ownership; the row variant earns
            its place when there are 20+ games.
          </p>
        </div>
        ...
        <div>
          ...
          <div className='grid grid-cols-4 gap-3.5'>
            {([
              { title: 'Rumikubi',    meta: '2 sessions · 2–4p', badge: 'OWN',    badgeCls: 'bg-yellow-primary border-yellow-tertiary text-ink-primary',    art: 'repeating-linear-gradient(135deg, #e8e2d0 0 8px, #dfd9c5 8px 16px)' },
              { title: 'Sushi Go!',  meta: '0 sessions · 2–5p', badge: 'FRIEND', badgeCls: 'bg-player-b border-player-b/60 text-ink-primary',               art: 'repeating-linear-gradient(45deg,  #e2e8d0 0 8px, #d5dfc5 8px 16px)' },
              { title: 'BG3',        meta: 'Joy Joy · 7d left',  badge: 'RENT',   badgeCls: 'bg-player-a border-player-a/60 text-ink-primary',               art: 'repeating-linear-gradient(135deg, #f0d4d4 0 8px, #e5c8c8 8px 16px)' },
              { title: 'Hearthstone',meta: '1 session · 3p',     badge: 'OWN',    badgeCls: 'bg-yellow-primary border-yellow-tertiary text-ink-primary',    art: 'repeating-linear-gradient(45deg,  #d8d4e8 0 8px, #c8c4dc 8px 16px)' },
            ] as const).map(({ title, meta, badge, badgeCls, art }) => (
              <article key={title} className='flex cursor-pointer flex-col overflow-hidden rounded-xl border border-border bg-card shadow-sm transition-[transform,box-shadow] hover:-translate-y-0.5 hover:shadow-md'>
                <div className='relative aspect-[3/4] border-b border-border'>
                  <div className='h-full w-full' style={{ background: art }} />
                  <span className={`absolute top-2.5 left-2.5 inline-flex items-center rounded-[4px] border px-2 py-0.5 font-mono text-[10px] font-bold uppercase tracking-[1.2px] ${badgeCls}`}>{badge}</span>
                </div>
                <div className='px-3.5 pt-3 pb-3.5'>
                  <h3 className='text-base font-bold leading-tight text-ink-primary'>{title}</h3>
        ...
        <div>
          ...
          <div className='overflow-hidden rounded-xl border border-border bg-card shadow-sm'>
            ...
            ] as const).map(({ title, meta, chip, art }, i, arr) => (
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            The atom of the timeline. Shows the game, the ranking, the date, and (optionally) a
            note. Tap anywhere to see the full session.
          </p>
        </div>
        ...
        <div className='grid grid-cols-2 gap-4'>
          ...
          <article className='flex flex-col gap-3 rounded-xl border border-border bg-card p-5 shadow-sm'>
            <header className='flex items-start justify-between gap-3'>
              ...
              <span className='inline-flex h-6 shrink-0 items-center rounded-sm border border-yellow-tertiary/40 bg-yellow-secondary px-2 font-mono text-[11.5px] text-ink-primary'>★ best run</span>
            </header>
            ...
            <ol className='flex flex-col divide-y divide-dashed divide-border'>
              {([
              ...
              ] as const).map(({ medal, p, initial, name, score, first }) => (
                <li key={name} className='grid grid-cols-[28px_36px_1fr_auto] items-center gap-3 py-1.5'>
                  ...
                  <span className='inline-flex h-9 w-9 items-center justify-center rounded-full border-[1.5px] border-ink-primary font-sans text-sm font-bold text-ink-primary' style={{ background: `var(--player-${p})` }}>{initial}</span>
          ...
          <article className='flex flex-col gap-3 rounded-xl border border-border bg-card p-5 shadow-sm'>
            ...
            <ol className='flex flex-col divide-y divide-dashed divide-border'>
              ...
              ] as const).map(({ medal, p, initial, name, first }) => (
            ...
            <footer className='flex gap-2 border-t border-dashed border-border pt-2'>
              <button className='inline-flex h-7.5 cursor-pointer items-center rounded-md px-2.5 text-xs font-semibold text-ink-secondary transition-colors hover:bg-paper-secondary hover:text-ink-primary'>View detail</button>
              <button className='inline-flex h-7.5 cursor-pointer items-center rounded-md px-2.5 text-xs font-semibold text-ink-secondary transition-colors hover:bg-paper-secondary hover:text-ink-primary'>Rematch</button>
            </footer>
          </article>
        </div>
      </section>
      ...
      <section className='space-y-6'>
        <div>
          ...
          <p className='mt-1 text-sm text-ink-secondary'>
            Lives on <code className='font-mono text-xs'>/players/&lt;name&gt;</code>. Hero block at
            top, then head-to-head and best-at modules below.
          </p>
        </div>
        ...
        <div className='grid grid-cols-[auto_1fr_auto] items-center gap-6 rounded-xl border border-border bg-card p-7 shadow-sm'>
          ...
          <div className='flex flex-col gap-2.5'>
            <h1 className='text-4xl font-extrabold leading-none tracking-tight text-ink-primary'>
              Alyne <span className='font-callout text-3xl text-yellow-tertiary'>— champion.</span>
            </h1>
            <div className='flex flex-wrap gap-1.5'>
              <span className='inline-flex h-6 items-center rounded-sm border border-yellow-tertiary/40 bg-yellow-secondary px-2 font-mono text-[11.5px] text-ink-primary'>9 pts</span>
          ...
          <div className='flex flex-col gap-2'>
            <button className='inline-flex h-7.5 cursor-pointer items-center rounded-md border border-border bg-card px-2.5 text-xs font-semibold text-ink-primary transition-colors hover:border-ink-muted hover:bg-paper-secondary'>Head-to-head</button>
            <button className='inline-flex h-7.5 cursor-pointer items-center rounded-md border border-yellow-tertiary bg-yellow-primary px-2.5 text-xs font-semibold text-ink-primary transition-colors hover:bg-yellow-tertiary'>+ Log session</button>
          </div>
        </div>
      </section>
      ...
      <section className='space-y-6'>
        ...
        <div className='grid grid-cols-2 gap-4'>
          <div className='flex flex-col items-center gap-2 rounded-xl border border-border bg-card px-6 py-9 text-center shadow-sm'>
            ...
            <button className='mt-2.5 inline-flex h-9.5 cursor-pointer items-center rounded-md border border-yellow-tertiary bg-yellow-primary px-3.5 text-sm font-semibold text-ink-primary transition-colors hover:bg-yellow-tertiary'>+ Log first session</button>
          </div>
          ...
          <div className='flex flex-col items-center gap-2 rounded-xl border border-border bg-card px-6 py-9 text-center shadow-sm'>
            ...
            <div className='mt-2.5 flex gap-2'>
              <button className='inline-flex h-7.5 cursor-pointer items-center rounded-md border border-yellow-tertiary bg-yellow-primary px-2.5 text-xs font-semibold text-ink-primary transition-colors hover:bg-yellow-tertiary'>+ Add game</button>
              <button className='inline-flex h-7.5 cursor-pointer items-center rounded-md border border-transparent bg-transparent px-2.5 text-xs font-semibold text-ink-secondary transition-colors hover:bg-paper-secondary hover:text-ink-primary'>Browse BGG</button>
            </div>
          </div>
        </div>
      </section>
