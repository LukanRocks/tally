...
export default function Leaderboard() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl space-y-12">
      ...
      {/* Global rankings */}
      <section>
        <h2 className="text-lg font-semibold text-foreground mb-4">Global Rankings</h2>
      ...
      <section>
        <h2 className="text-lg font-semibold text-foreground mb-4">Per-Game Leaderboard</h2>
        <select value={selectedGame} onChange={e => setSelectedGame(Number(e.target.value))}
          className="border border-border rounded-lg px-3 py-2 text-sm mb-4 bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-ring">
      ...
      <section>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-4">
          ...
          <span className="flex items-center text-muted-foreground font-bold">vs</span>
          ...
          <div className="bg-card border border-border rounded-xl p-6">
            <div className="grid grid-cols-3 gap-4 text-center mb-6">
              <div>
                ...
                <p className="text-3xl font-black text-primary mt-1">{h2h.p1_wins}</p>
              ...
              <div>
                ...
                <p className="text-3xl font-black text-primary mt-1">{h2h.p2_wins}</p>
                <p className="text-xs text-muted-foreground">wins</p>
              </div>
            </div>
