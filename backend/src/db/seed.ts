...
const GAMES = [
  ...
  { name: 'Lost Ruins of Arnak', description: 'Explore an island, fight guardians, and unlock ancient mysteries.', min_players: 1, max_players: 4, year_published: 2020, bgg_id: 312484 },
