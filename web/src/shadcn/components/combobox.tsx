...
import { InputGroup, InputGroupAddon, InputGroupButton, InputGroupInput } from '@/shadcn/components/input-group'
...
function ComboboxChip({
  ...
  return (
    ...
    >
      {children}
      {showRemove && (
        <ComboboxPrimitive.ChipRemove render={<Button variant='ghost' className='size-5 p-0' />} className='-ml-1 opacity-50 hover:opacity-100' data-slot='combobox-chip-remove'>
          <XIcon className='pointer-events-none' />
