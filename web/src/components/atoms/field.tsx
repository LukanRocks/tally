...
export const FieldContent = ({ className, ...props }: ComponentProps<'div'>) => (
  <div
...
export const FieldDescription = ({ className, ...props }: ComponentProps<'p'>) => (
  <p
    ...
    className={cn(
      'text-left text-sm leading-normal font-normal text-ink-muted group-has-data-horizontal/field:text-balance [[data-variant=legend]+&]:-mt-1.5',
      'last:mt-0 nth-last-2:-mt-1',
      '[&>a]:underline [&>a]:underline-offset-4 [&>a:hover]:text-ink-primary',
      className,
    )}
    {...props}
  />
...
export const FieldSeparator = ({
  ...
  >
    ...
    {children && (
      <span
        className='relative mx-auto block w-fit bg-paper-primary px-2 text-ink-muted'
