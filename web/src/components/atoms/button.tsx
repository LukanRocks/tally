...
export const ButtonGroupText = ({ className, polymorphic = false, ...props }: ButtonGroupTextProps) => {
  ...
  const classes = cn("flex items-center gap-2 rounded-4xl border bg-muted px-2.5 text-sm font-medium [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4", className)
