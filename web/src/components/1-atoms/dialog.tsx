...
const DIALOG_CONTENT_VARIANTS_CONFIG = cva(
  'fixed top-1/2 left-1/2 z-50 flex -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-2xl bg-paper-primary text-sm text-ink-primary shadow-md ring-1 ring-ink-primary/5 duration-100 outline-none data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95',
  {
    variants: {
      size: {
...
export const Dialog = ({ ...props }: ComponentProps<typeof DialogPrimitive.Root>) => <DialogPrimitive.Root data-slot='dialog' {...props} />

export const DialogTrigger = ({ ...props }: ComponentProps<typeof DialogPrimitive.Trigger>) => <DialogPrimitive.Trigger data-slot='dialog-trigger' {...props} />

export const DialogPortal = ({ ...props }: ComponentProps<typeof DialogPrimitive.Portal>) => <DialogPrimitive.Portal data-slot='dialog-portal' {...props} />

export const DialogClose = ({ ...props }: ComponentProps<typeof DialogPrimitive.Close>) => <DialogPrimitive.Close data-slot='dialog-close' {...props} />
