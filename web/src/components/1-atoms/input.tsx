...
export const Input = ({ className, ...props }: InputProps) => (
  <input
    data-slot='input'
    className={cn(
      'h-9 w-full min-w-0 rounded-lg border border-transparent bg-paper-muted/50 px-3 py-1 text-sm transition-[color,box-shadow,background-color] outline-none file:mr-3 file:inline-flex file:h-7 file:cursor-pointer file:rounded-md file:border-0 file:bg-paper-secondary file:px-2 file:text-sm file:font-medium file:text-ink-primary placeholder:text-ink-muted focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/30 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40',
      className,
    )}
    {...props}
  />
